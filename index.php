            ...
            ?>
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="card" id="h500" style="width: 19rem;">
                        <img id="cardimage" src="<?php echo $row["product_image"]?>.png" class="card-img-top"
                            alt="..." />
                        <div class="card-body">
                            ...
                            <a href="#" class="btn btn-primary card-link" data-bs-toggle="modal"
                                data-bs-target="#modalId">Show More</a>
                        </div>
                    </div>
                </div>
                <?php } ?>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-12 p-lg-5 p-2 my-5">
                    ...
                    <p>
                        ...
                        .com (Innovative Retail Concepts Private Limited) is India’s largest online food and grocery
                        store. With over
                        18,000 products and over
                        a 1000 brands in our catalogue you will find everything you are looking for. Right from Millets
                        and cereals,
                        Rice and Dals, Spices and Seasonings to Packaged products we have it all.Choose from a wide
                        range of options in every category, exclusively
                        handpicked to help you find the best quality available at the lowest prices. Select a time slot
                        for delivery
                        and your order will be delivered right to your doorstep, anywhere in Bangalore, Hyderabad,
                        Mumbai, Pune, Chennai, Delhi, Noida, Mysore, Coimbatore, Vijayawada-Guntur, Kolkata,
                        Ahmedabad-Gandhinagar, Lucknow-Kanpur, Gurgaon, Vadodara, Visakhapatnam, Surat, Nagpur, Patna,
                        Indore and Chandigarh Tricity You can pay online using your debit / credit card or by cash /
                        sodexo on delivery.
                ...
                <div class="col-lg-6 col-md-6 col-12">
                    ...
                    <form>
                        <div id="social-container">
                            <a href="https://www.facebook.com/v7lancersOfficial" class="social"><i
                                    class="fa fa-facebook"></i></a>
                            <a href="https://twitter.com/VLancers" class="social"><i class="fa fa-twitter"></i></a>
                            <a href="https://www.linkedin.com/company/v7-lancers/" class="social"><i
                                    class="fa fa-linkedin"></i></a>
                            <a href="https://www.instagram.com/v7_lancers/" class="social"><i
                ...
                <div class="modal-body">
                    <div class="row mt-2 p-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <h4><span class="product_price"></span><span> / </span><span
                                    class="product_quantity"></span>g</h4>
